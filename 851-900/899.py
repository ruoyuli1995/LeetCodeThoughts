...
This problem is quite tricky, but it will be not so hard if you can associate it with bubble sort, as someone points out in discussion.
When trying to solve it, I can only make it when K == 1, Q_Q again.
'''
